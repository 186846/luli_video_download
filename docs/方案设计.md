...
| 文件 | 说明 |
|------|------|
| `web/src/views/HomeView.vue` | 首页：解析、下载、AI 总结入口 |
| `web/src/views/SummaryView.vue` | 总结详情：摘要 / 字幕 / 弹幕 / 导图 / 问答 |
| `web/src/components/MindMapCanvas.vue` | NoteGPT 风格思维导图画布 |
| `web/src/api/client.js` | API 调用（含 SSE） |
